...
/**
 * This demo adds an extension of the RadialTreeLayout to the original RadialGraphView demo, 
 * which enables the user to set the root item explicitely
 * 
 * @version 1.0
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */
public class RadialGraphViewCustomRootItem extends Display {

    public static final String DATA_FILE = "datasets/socialnet.xml";
    ...
    public RadialGraphViewCustomRootItem(Graph g, String label) {
	...
	NodeItem firstRootItem = (NodeItem)m_vis.getVisualItem(treeNodes, g.getNode(11));
	
	
	// create the tree layout action
	RadialTreeLayoutCustomRootItem treeLayout = new RadialTreeLayoutCustomRootItem(tree,firstRootItem);
	...
	final RadialGraphViewCustomRootItem gview = new RadialGraphViewCustomRootItem(g, label);
    ...
    /**
     * Extends the original RadialTreeLayout so that the next root item can be set explicitly
     * 
     * @author goose
     *
     */
	 ...
	 * @param firstRootItem the item we should be used as the first root item
	 */
